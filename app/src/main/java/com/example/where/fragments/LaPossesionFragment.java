...
public class LaPossesionFragment extends Fragment {
    ...
    public LaPossesionFragment() {

    }


    public static LaPossesionFragment newInstance(String param1, String param2) {
        LaPossesionFragment fragment = new LaPossesionFragment();
